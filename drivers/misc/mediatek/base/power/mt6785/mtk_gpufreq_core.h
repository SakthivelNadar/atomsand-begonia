...
#define SEG_GPU_DVFS_FREQ1		(850000)	/* KHz */
...
#define SEG_GPU_DVFS_VOLT0		(79000)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT1		(78775)		/* mV x 100 */
#define SEG_GPU_DVFS_VOLT2		(78350)		/* mV x 100 */
